...
import GoogleAPI from '../../assets/images/googleapi.png'; 
            ...
            <td>
              <a href='https://github.com/PranavMarthi/VirtualAssistant'  target="_blank" rel="noopener noreferrer">
                ...
                <span className='project-text'>
                  ...
                  <img src={Python} alt="Google Logo" width="50px" height="50px" style={{
                    "position":"relative",
                    "left":"25%",
                    "bottom":"18%"
                  }}/>
                  <img src={GoogleAPI} alt="Apify Logo" width="75px" height="40px" style={{
                    "position":"relative",
                    "left":"50%",
                    "bottom":"10%"
                  }}/>
